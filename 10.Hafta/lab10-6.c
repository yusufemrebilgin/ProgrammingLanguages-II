/*
    Kendisine parametre olarak aktarılan head isimli liste ve yaş parametresine göre işlem  yapan ve 
    listedeki yaş değerine sahip düğümü bularak silen fonksiyonu yazınız.
*/
#include <stdio.h>
#include <stdlib.h>
